...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AISStore.Models.Client", b =>
                {
            ...
            modelBuilder.Entity("AISStore.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("AISStore.Models.EmployeeType", b =>
                {
                    b.Property<int>("EmployeeTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AISStore.Models.Item", b =>
                {
            ...
            modelBuilder.Entity("AISStore.Models.ItemType", b =>
                {
            ...
            modelBuilder.Entity("AISStore.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("AISStore.Models.OrderItem", b =>
                {
                    b.Property<int>("OrderItemsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AISStore.Models.Price", b =>
                {
                    b.Property<int>("PriceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AISStore.Models.Provider", b =>
                {
            ...
            modelBuilder.Entity("AISStore.Models.Stock", b =>
                {
                    b.Property<int>("StockId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AISStore.Models.Supply", b =>
                {
            ...
            modelBuilder.Entity("AISStore.Models.SupplyItem", b =>
                {
            ...
            modelBuilder.Entity("AISStore.Models.SupplySupplyItem", b =>
                {
                    b.Property<int>("SupplyItemsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AISStore.Models.Employee", b =>
                {
                    b.HasOne("AISStore.Models.EmployeeType", "EmployeeType")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("AISStore.Models.Item", b =>
                {
                    b.HasOne("AISStore.Models.Price", "Price")
                        .WithMany("Items")
                        .HasForeignKey("PriceId")
                        .IsRequired()
                        .HasConstraintName("PriceID");

                    b.HasOne("AISStore.Models.Stock", "Stock")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("AISStore.Models.Order", b =>
                {
                    b.HasOne("AISStore.Models.Client", "Client")
                        .WithMany("Orders")
                        .HasForeignKey("ClientId")
                        .IsRequired()
                        .HasConstraintName("ClientID");

                    b.HasOne("AISStore.Models.Employee", "Employee")
                        .WithMany("Orders")
                        .HasForeignKey("EmployeeId")
                        .IsRequired()
                        .HasConstraintName("EmployeeID");

                    b.HasOne("AISStore.Models.OrderItem", "OrderItems")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("AISStore.Models.OrderItem", b =>
                {
                    b.HasOne("AISStore.Models.Item", "Item")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("AISStore.Models.Stock", b =>
                {
                    b.HasOne("AISStore.Models.ItemType", "ItemType")
                        .WithMany("Stocks")
            ...
            modelBuilder.Entity("AISStore.Models.Supply", b =>
                {
                    b.HasOne("AISStore.Models.Provider", "Provider")
                        .WithMany("Supplies")
            ...
            modelBuilder.Entity("AISStore.Models.SupplySupplyItem", b =>
                {
                    b.HasOne("AISStore.Models.Supply", "Supply")
                        .WithMany("SupplySupplyItems")
                        .HasForeignKey("SupplyId")
                        .IsRequired()
                        .HasConstraintName("SupplyID");

                    b.HasOne("AISStore.Models.SupplyItem", "SupplyItem")
                        .WithMany("SupplySupplyItems")
